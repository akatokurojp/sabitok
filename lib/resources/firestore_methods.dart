...
import 'package:sabitok/models/livestream.dart';
import 'package:sabitok/providers/user_provider.dart';
import 'package:sabitok/resources/storage_methods.dart';
import 'package:sabitok/utils/utils.dart';
    ...
    try {
      if (title.isNotEmpty && image != null) {
        if (!((await _firestore
          ...
          showSnackBar(
              context, 'Two Live Stream cannot start at the same time');
        }
      } else {
